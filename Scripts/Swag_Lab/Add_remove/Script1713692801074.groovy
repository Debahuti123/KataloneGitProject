...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_first-name'), 'd')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_last-name'), 'p')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postal-code'), '3344231')
...
WebUI.rightClick(findTestObject('Object Repository/Page_Swag Labs/div_Your order has been dispatched, and wil_5880e8'))
